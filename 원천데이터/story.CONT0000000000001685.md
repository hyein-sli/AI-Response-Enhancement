...
* [1. 원격으로 창문을 제어하는 ‘리모트 윈도우 컨트롤’](#target2)
* [2. 실내 공기를 깨끗하게 만든다. ‘공기청정 모드’](#target5)
* [3. 앉은 자세를 한층 더 편하게](#target8)
* [4. 인포테인먼트 시스템의 즐겨찾기 기능 ‘사용자 버튼’](#target13)
* [5. 이중주차 시 유용한 ‘시프트 락 릴리즈’](#target16)
* [6. 험로 주행을 안전하게 돕는 경사로 저속 주행 기능&험로 주행 모드](#target19)
...
*분량*9분 *읽기*올해 눈길에서 유독 강했던 제네시스, 지난해 구매 고객 가운데 75%가 4륜구동 선택

*분량*5분 *읽기*미리 보고 대처한다, 제네시스 GV80의 ‘프리뷰 전자제어 서스펜션’

*분량*5분 *읽기*제네시스, 캐나다에서 최고의 자동차로 선정된 비결은 무엇일까?
